...
export const Box = forwardRef(function Box(
  ...
  const resolvedStyle: React.CSSProperties = {
    ...
    paddingLeft: spacingToken(px) ?? spacingToken(pl),
    paddingRight: spacingToken(px) ?? spacingToken(pr),
    paddingTop: spacingToken(py) ?? spacingToken(pt),
    paddingBottom: spacingToken(py) ?? spacingToken(pb),
    margin: spacingToken(m),
    marginLeft: spacingToken(mx) ?? spacingToken(ml),
    marginRight: spacingToken(mx) ?? spacingToken(mr),
    marginTop: spacingToken(my) ?? spacingToken(mt),
    marginBottom: spacingToken(my) ?? spacingToken(mb),
